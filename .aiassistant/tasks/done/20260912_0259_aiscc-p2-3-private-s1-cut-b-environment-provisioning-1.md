# 작업지시서: P2-3 private S1 Cut B environment provisioning

## meta

- task_id: `20260912_0259_aiscc-p2-3-private-s1-cut-b-environment-provisioning-1`
...
- fresh_ide_executor_chat_reason: `Git-persisted source authority → persistent Docker image/database environment side effects`
...
```text
.aiassistant/tasks/active/20260912_0259_aiscc-p2-3-private-s1-cut-b-environment-provisioning-1.md
```
...
SHA-256:
2da742f803b402b39f0433a0e1fabb74c8a594b93cd782555797b05d18cfc9c2

.aiassistant/reports/aiscc/20260912_0259_aiscc-p2-3-cut-a-persistence-final-acceptance-cut-b-authorization-judgment-1.md
SHA-256:
d64582a0a3b7040cf4a56961d7905b194949716eda98e9832a66a1c68996629d
```
...
io.aiscc.task-id=20260912_0259_aiscc-p2-3-private-s1-cut-b-environment-provisioning-1
```
...
```text
.aiassistant/reports/target/20260912_0259_aiscc-p2-3-private-s1-cut-b-environment-provisioning-1/
```
