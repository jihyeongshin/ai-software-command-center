# 작업지시서: P2-3 private S1 Cut B self-reference correction provisioning retry

## meta

- task_id: `20260912_0410_aiscc-p2-3-private-s1-cut-b-self-reference-correction-provisioning-retry-1`
- predecessor_task: `.aiassistant/tasks/done/20260912_0348_aiscc-p2-3-private-s1-cut-b-artifact-hash-correction-provisioning-retry-1.md`
...
- work_type: `ENVIRONMENT_PROVISIONING / CUT_B / SELF_REFERENCE_CORRECTION_RETRY`
...
- fresh_ide_executor_chat_reason: `same Cut B provisioning authority; 0400 stopped before Cycle/Judgment placement and before Docker/environment side effects`
...
The current 0410 Task MUST NOT be treated as a predecessor.

Then reconcile only the stale failed 0400 active Task:

```text
.aiassistant/tasks/active/20260912_0400_aiscc-p2-3-private-s1-cut-b-identity-ownership-correction-provisioning-retry-1.md

expected SHA-256:
5cfb5a3ff7f54f1cca505cf267542a82f9c571d9462a6ed7fc4dbc18489a30f0
```

If it exists, require all three:
...
Then delete exactly that stale 0400 active Task.
...
Do not test the current 0410 active Task for absence.
...
SHA-256:
93f5b7dc5ff55ee7dfe212c79a53e0e7cc1d05b7aafbda7b39f7523947ec8fdc

.aiassistant/reports/aiscc/20260912_0410_aiscc-p2-3-cut-b-self-reference-contract-defect-retry-judgment-1.md
SHA-256:
78f4ec2f7feb8fac541eb7c258bf39eb359515c4a565a1c4edf0bd4c491618a1
```

Any mismatch before artifact placement:
...
Before this delivery the exact Git-visible tracked/untracked governance baseline is:

```text
6 exact
```

Exact predecessor paths and hashes:
...
- `.aiassistant/tasks/done/20260912_0410_aiscc-p2-3-private-s1-cut-b-self-reference-correction-provisioning-retry-1.md`  `46b9fb7d030053eb12ac75827475ab136c12cb51b83e3a82b5516b7feee80b96`
...
The 0400 failed active Task is ignored and therefore is not part of this Git-visible
count.

After stale-0400-active reconciliation and placement of the current Cycle/Judgment,
while the current 0410 Task remains active:
...
Require all 19 accepted Cut A paths exact as listed later in the inherited Cut B
...
io.aiscc.task-id=20260912_0410_aiscc-p2-3-private-s1-cut-b-self-reference-correction-provisioning-retry-1
```
...
Before moving the current 0410 Task to done, successful provisioning must have exactly:
...
```text
.aiassistant/reports/target/20260912_0410_aiscc-p2-3-private-s1-cut-b-self-reference-correction-provisioning-retry-1/
```
